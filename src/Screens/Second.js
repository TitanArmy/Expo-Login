  ...
  render() {
    ...
    return (
      ...
      <View style={{flex:1}}>
        <View >
          <TouchableOpacity 
		  style={{ zIndex:1,marginTop:30,width:30,marginHorizontal:15 }}
        ...
        <View style={[styles.map, { zIndex: 1, marginTop: "10%", marginLeft: "50%" }]}>
          <Image
    ...
    /> */}
		...
		<View style={{position:'absolute',alignSelf:'center',marginTop:650,backgroundColor: '#FFA500',width:140,height:40,
borderRadius:19}}>
			<TouchableOpacity style={{borderRadius:30}}>
				<Text style={{color:'white',alignSelf:'center',marginTop:8}}>Pick Up</Text>
			</TouchableOpacity>
		</View>
      </View>
